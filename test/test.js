...
describe('metainspector', function () {
	...
	describe('client', function () {
		...
		it('should identify og image using og:image property', function (done) {
			client = new MetaInspector("http://www.ogimage.com:80/", {});
			...
			client.on("error", (error) => {
				console.error("errorxxxx:" + JSON.stringify(error));
			});

			client.fetch();
		});

		it('should identify og image using og:image:url property', function (done) {
			client = new MetaInspector("http://www.ogimageurl.com:80/", {});
